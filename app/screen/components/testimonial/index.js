...
export const Testimonial = () => {
    ...
    return (
        <>
            <section className='coponies-section pt-5 px-5 xl:pt-10 xl:pb-40' style={{ background: '#fff' }}>
                <div className='container mx-auto'>
                    <div className='section-title text-center'>
                        <h6 className='font-semibold  text-sm xl:text-xl'>Clients Feedback</h6>
                        <h4 className='font-bold text-primary text-3xl xl:text-5xl mt-2'>Testimonial<span className=' text-blue'></span></h4>
                    </div>
                        ...
                        <Slider {...settings} style={{ padding: '0px 20px' }}>
                            {
                                dummyArray.map((item, index) => {
                                    return (
                                        <div className='mb-10 text-left px-5' >
                                            ...
                                            <div className='cursor-pointer mx-auto bg-gray rounded-[20px] p-10'>
                                                <p>{item.message}</p>
