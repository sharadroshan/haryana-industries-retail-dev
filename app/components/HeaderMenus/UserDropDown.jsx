...
import { ArrowRightEndOnRectangleIcon, Bars3Icon, EnvelopeIcon, UserCircleIcon } from '@heroicons/react/24/outline';
        ...
        <div className="text-right h-full">
            <Menu as="div" className="relative inline-block text-left h-full">
                <div className='h-full'>
                    <Menu.Button className="h-full flex items-center text-white py-1 px-4 font-semibold rounded-tr-2xl rounded-br-2xl bg-gradient h-full">
