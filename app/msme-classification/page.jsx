            ...
            <section className='coponies-section py-10  xl:pt-10 xl:pb-40 mt-0 lg:mt-10' >
                <div className='xl:container mx-auto px-5'>
                    <div className='section-title text-center mb-10'>
                        ...
                        <h4 className='font-bold text-secondary text-2xl xl:text-4xl mt-2'>MSME Classification<span className=' text-blue'> </span></h4>
                    </div>
                                ...
                                <div className='service-card shadow p-5 rounded-2xl bg-white mb-3 p-2 rounded'>
                                    <div className='flex items-start justify-between w-full'>
                                        <div>
                                            ...
                                            {/* <h5 className='text-left text-[18px] mt-2'>Offers - <span className='font-bold text-primary text-[22px] '>34</span></h5> */}
                                        </div>
                                        <Image
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 ">
                                    {
                                        dummyArray.map((item, index) => {
                                            return (
                                                <div className='service-card shadow p-5 rounded-2xl bg-white mb-3 p-2 rounded' key={index}>
                                                    <div className='flex items-start justify-between w-full'>
                                                        <div>
                                                            <h4 className='font-bold text-left text-[20px] '>MSME Offer {index + 1}</h4>
