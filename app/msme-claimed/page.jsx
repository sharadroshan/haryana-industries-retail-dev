            ...
            <section className='coponies-section py-10  xl:pt-10 xl:pb-40 mt-0 lg:mt-10' style={{ background: '#f1f1f1' }}>
                <div className='xl:container mx-auto px-5'>
                    <div className='section-title text-center mb-10'>
                        ...
                        <h4 className='font-bold text-primary text-3xl xl:text-5xl mt-2'>MSME<span className=' text-blue'> Claimed</span></h4>
                    </div>
                    <div className='' >
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 ">
                                        ...
                                        dummyArray.map((item, index) => {
                                            return (
                                                <div className='service-card shadow p-8 rounded-2xl bg-white mb-3 p-2 rounded' key={index}>
                                                    <h4 className='font-bold text-left text-[20px] mt-5'>Claimed Name</h4>
                                                    <div className='flex items-center'>
                                                        <a href='https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf' target='_blank' className='w-full mr-2'>
                                                            <button className='bg-primary hover:bg-secondary p-2 py-3 text-white  rounded w-full mt-5 mr-1 flex justify-center'>
                                                        ...
                                                        <button onClick={openModal} className='bg-primary hover:bg-secondary p-2 py-3 text-white  rounded w-full mt-5  flex justify-center'>
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{ width: '25px' }} className='mr-2'>
                            ...
                            <div>
                                <div className='service-card shadow p-8 rounded-2xl bg-white mb-3 p-2 rounded h-[300px] sticky top-0'>
                                    <div className='mt-5'>
                                        <div className='m-auto w-auto flex items-center justify-center text-center text-xl '>
                                            <div onClick={openModal} className='cursor-pointer w-[80px] h-[80px] bg-secondary hover:bg-primary text-white rounded-[40px] p-5'>
