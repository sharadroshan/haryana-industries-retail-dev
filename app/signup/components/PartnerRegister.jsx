...
const PartnerRegister = ({ handleBack }) => {
        ...
        <>
            <div className=" max-w-xl">
                ...
                <div className="mt-8 space-y-5">
                    ...
                    <div className="-space-y-px rounded-md ">
                        <div className="group relative w-72 md:w-80 lg:w-96 relative">
                            <label htmlFor="0" className="block w-full pb-1 text-sm font-medium text-gray-400 transition-all duration-200 ease-in-out group-focus-within:text-blue-400">Partner Name*</label>
                            <input
                                id="0"
                                type="text"
                                className="peer h-10 w-full rounded-md bg-gray-50 px-4 font-500 outline-none drop- transition-all duration-200 ease-in-out focus:bg-white focus:ring-2 focus:ring-blue-400 border text-blue text-[14px]"
                    ...
                    <div>
                        <label for="countries" className="block mb-2 text-sm font-medium text-black ">Select Constitution*</label>
                    ...
                    <div>
                        <label for="countries" className="block mb-2 text-sm font-medium text-black ">Select Profession*</label>
                        <select id="countries" className="border border-secondary text-secondary text-sm rounded-lg focus:ring-secondary focus:border-secondary block w-full p-2.5 ">
