    ...
    return (
        <div>
            <section className='coponies-section py-10  xl:pt-10 xl:pb-40 mt-0 ' >
                <div className='xl:container mx-auto px-5 lg:flex items-center justify-center'>
                    <div className='bg-white rounded-lg p-5'>
                        <div className='section-title text-center lg:mb-10'>
                            <h4 className='font-bold text-secondary text-xl xl:text-2xl mt-2'>Incentive Checklist Details</h4>
                        </div>
                                            ...
                                            dummyData.map((item, index) => {
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td className='border-b border-gray500 font-medium py-4 px-4 text-sm text-right whitespace-nowrap'>30 Days</td>
                                                        <td className='border-b border-gray500 font-medium py-4 px-4 text-sm text-right whitespace-nowrap'>5 Years</td>
